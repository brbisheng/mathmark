...
def _build_config(data: dict[str, Any]) -> WatermarkConfig:
    ...
    return WatermarkConfig(
        ...
        visible=VisibleSettings(
            ...
            position=visible_d.get("position", "diagonal_scatter"),
            opacity=visible_d.get("opacity", 0.30),
            font_size_ratio=visible_d.get("font_size_ratio", 0.04),
            color=tuple(visible_d.get("color", (160, 160, 160))),
            scatter_count_x=visible_d.get("scatter_count_x", 3),
            scatter_count_y=visible_d.get("scatter_count_y", 2),
            scatter_angle=visible_d.get("scatter_angle", -30.0),
    ...
    data = {
        ...
        "watermark": {
            ...
            "visible": {
                ...
                "font_size_ratio": config.visible.font_size_ratio,
                "color": list(config.visible.color),
                "scatter_count_x": config.visible.scatter_count_x,
                "scatter_count_y": config.visible.scatter_count_y,
                "scatter_angle": config.visible.scatter_angle,
